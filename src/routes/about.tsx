        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <Reveal>
              ...
              <p className="mt-4 max-w-xl text-muted-foreground">Today we operate over 5 outlets nationwide, and partner with thousands of farmers, suppliers and franchise owners across the country.</p>
            </Reveal>
            <Reveal delay={0.1}>
