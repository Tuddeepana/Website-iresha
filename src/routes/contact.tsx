  ...
  head: () => ({
    meta: [
      { title: "Contact — Iresha Holdings" },
      {
        name: "description",
        content:
          "Contact Iresha Holdings — group office, business units, and partnership enquiries.",
      },
        ...
        <Container>
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-white/75">
              Whether you are a customer, supplier, partner or future colleague — we are here to
              help.
            </p>
          </Reveal>
        </Container>
